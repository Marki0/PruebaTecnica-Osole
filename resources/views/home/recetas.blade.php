...
@section('content')
    @if (! $nikitosPublicLinked)
        <div class="nk-banner-warn nk-wrap" style="margin-top:0.5rem;">
            <p>Los PNG del mockup van en <code>public/nikitos/</code> (minúsculas) y tienen que estar en el repositorio. Si falta la carpeta, cloná de nuevo tras un <code>git push</code> que la incluya.</p>
        </div>
    @endif
